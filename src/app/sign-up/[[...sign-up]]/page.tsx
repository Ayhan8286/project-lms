...
export default function Page() {
    return (
        <div className="flex flex-col items-center justify-center h-full min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-400 to-slate-900 gap-y-6 p-4">
            <div className="flex flex-col items-center gap-y-2 text-white drop-shadow-md">
                ...
                <p className="text-slate-200">Join our community of learners today</p>
            </div>
